...
namespace GoLine
{
    ...
    public partial class UserPage : Page
    {
        ...
        private void UpdateAccount(GameServices.OnlineAccount account, bool logMe = false)
        {
        ...
        private void ShowError(GameServices.ConnectResult connectResult)
        {
            string errorinfo = string.Empty;
            switch (connectResult)
            {
                case GameServices.ConnectResult.ConnectFail:
                    errorinfo = Properties.Resources.ConnectFail;
                    break;
                case GameServices.ConnectResult.EmptyUserNameOrPsw:
                    errorinfo = Properties.Resources.EmptyUserNameOrPsw;
                    break;
                case GameServices.ConnectResult.GenerateRecordFail:
                    errorinfo = Properties.Resources.GenerateRecordFail;
                    break;
                case GameServices.ConnectResult.OtherError:
                    errorinfo = Properties.Resources.OtherError;
                    break;
                case GameServices.ConnectResult.UserExist:
                    errorinfo = Properties.Resources.UserExist;
                    break;
                case GameServices.ConnectResult.UserNotExist:
                    errorinfo = Properties.Resources.UserNotExist;
                    break;
                case GameServices.ConnectResult.WrongPassword:
        ...
        private async void SignupBtnClick(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                GameServices.ConnectResult result = GameServices.ConnectResult.ConnectFail;
                Processing.IsEnabled = true;
                await Task.Run(() => 
                {
                    result = App.NetDBService.Register(nickName, username, password, out errorMsg);
                });
                if (result == GameServices.ConnectResult.Success)
                {
