...
namespace GoLine
{
    ...
    public partial class HomePage : Page
    {
        ...
        private void OnHomePageLoaded(object sender, RoutedEventArgs e)
        {
            ...
            Application.Current.Activated += OnApplicationActived;
            ...
            AvailbleMode = new List<SelectionItem<GameMode>>()
            {
                ...
                new SelectionItem<GameMode>(Properties.Resources.Online,  GameMode.Online),
            };
        ...
        private void OnApplicationActived(object sender, System.EventArgs e)
        {
            StartBtn.IsEnabled = true;
        }

        private void OnApplicationDeactivated(object sender, System.EventArgs e)
        {
        ...
        private async void OnModeSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if(selectedMode.Value == GameMode.Online)
            {
            ...
            if (selectedMode.Value == GameMode.PVE && App.LoginedAccount == null)
            {
                //Show dialog
                var dialog = new Epx.Controls.MessageDialog()
                {
